...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Exceção lançada quando um valor negativo é utilizado noo argumento <paramref name="valor"/></exception>
        ...
        public override string ToString()
        {
            ...
            return $"Numero: {Numero}, Agencia {Agencia}, Saldo {Saldo}";
            //return $"Numero: {0}, Agencia {1}, Saldo {2}", Numero, Agencia, Saldo;
        }
    }
